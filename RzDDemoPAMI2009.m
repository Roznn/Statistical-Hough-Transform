...
figure;imagesc(iradon(sht3',-spaceTheta*180/pi,max(size(N)),'nearest','Hann')), colormap(gray),title('backprojection SHT3 with inverse Radon transform')
toc
